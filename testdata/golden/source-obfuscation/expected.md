...
开发者可参考[ArkGuard混淆开启指南](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/source-obfuscation-guide)，了解如何开启混淆并自定义混淆规则。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/74/v3/R8cgdDKwQ7-R-noxAkFSug/zh-cn_image_0000002742122251.png?HW-CC-KV=V1&HW-CC-Date=20260907T063258Z&HW-CC-Expire=86400&HW-CC-Sign=F87BC1055F51F9C0400A9E646A44F117BE3D07AB374A9BB63B44FD603B455DF1)
...
在使用混淆功能前，建议开发者先通过文档了解[混淆选项的能力](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/source-obfuscation-rule-options)与[混淆选项所需要保留白名单的场景](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/source-obfuscation-keep-options)，再根据开发需求选择对应的混淆功能。
...
- **如果当前编译模块混淆配置未包含-enable-lib-obfuscation-options选项**：合并对象为当前模块的所有混淆规则与依赖模块混淆规则中的[保留选项](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/source-obfuscation-keep-options)。
