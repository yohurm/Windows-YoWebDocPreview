...
& cmd /c "$CargoRunner test -p yohu-protocol -p yohu-domain -p yohu-runtime -p yohu-source -p yohu-library -p yohu-md-convert -p yohu-md-github -p yohu-ai -p yohu-ai-cli -p yohu-docs-cli"
if ($LASTEXITCODE -ne 0) {
